...
description: Guides salespeople through April Dunford's 8-component sales pitch framework from "Sales Pitch". Use when creating sales presentations, demo scripts, discovery processes, or sales enablement materials. Focuses on helping buyers make confident decisions by establishing market context before demonstrating product capabilities. Use this for structured buyer-decision pitches. For narrative-first storytelling, use raskin-pitch instead. For positioning strategy, use dunford-positioning.
